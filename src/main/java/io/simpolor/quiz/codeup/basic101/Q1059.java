...
public class Q1059 {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(Integer.toBinaryString(input)); // 2진수
        // System.out.println(Integer.toOctalString(input)); // 8진수
        // System.out.println(Integer.toHexString(input)); // 16진수
        // System.out.println(Integer.parseInt(input)); // 다시 정수로 치환
    }
}
